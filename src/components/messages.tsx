                ...
                {suggestions.map((suggestion) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <div
                        className={`w-8 h-8 sm:w-9 sm:h-9 ${suggestion.bgColor} rounded-lg flex items-center justify-center transition-transform group-hover:scale-110 flex-shrink-0`}
                      >
                        <div className="w-4 h-4 sm:w-5 sm:h-5">{suggestion.icon}</div>
                      </div>
                      <h3
                        className={`font-semibold text-sm sm:text-base transition-colors leading-tight ${
                          activeSuggestion?.id === suggestion.id
                            ? 'text-brand-red-600'
